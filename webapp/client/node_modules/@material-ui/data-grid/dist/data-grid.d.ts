...
declare function Watermark(): JSX.Element | null;
 ...
 * @event
 */
declare const GRID_EDIT_ROWS_MODEL_CHANGE = "editRowsModelChange";
/**
...
declare function useGridEditRows(apiRef: GridApiRef, props: Pick<GridComponentProps, 'editRowsModel' | 'onEditRowsModelChange'>): void;

declare const gridSelectionStateSelector: (state: GridState) => GridSelectionModel;
declare const selectedGridRowsCountSelector: OutputSelector<GridState, number, (res: GridSelectionModel) => number>;
declare const selectedGridRowsSelector: OutputSelector<GridState, Map<GridRowId, GridRowData>, (res1: GridSelectionModel, res2: GridRowsLookup) => Map<GridRowId, GridRowData>>;
declare const selectedIdsLookupSelector: OutputSelector<GridState, Record<string, GridRowId>, (res: GridSelectionModel) => Record<string, GridRowId>>;
